...
<body>
    <div id="content">
        ...
        <header id="headerSessões">
            ...
            <div id="banner" style="background-image: url(../img/the-batman.jpg);"></div>
        </header>
        <div id="mainFilmes">
            <!---------------------Quadro Cadeiras--------------------->
            ...
            <h1 id="titulo-filme" data-filme="The Batman">THE BATMAN</h1>
            <div id="extras">
                <div id="trailer">
                    <!--No link colocar /embed/o código do vídeo-->
                    <iframe src="https://www.youtube.com/embed/0coLXVN5eT4?fs=1" allowfullscreen></iframe>
                </div>
                <ul id="informacoes">
                    <li><span>Gênero:</span> Ação, Crime</li>
                    <li><span>Duração:</span> 1h 00min</li>
                    <li><span>indicação:</span> +14</li>
                    <li><span>Direção:</span>  Matt Reeves</li>
                    <li><span>Elenco:</span>  Robert Pattinson, Colin Farrell, Zoë Kravitz</li>
                    <li><span>Nacionalidade:</span> EUA</li></li>
                </ul>
            </div>
            <div id="principal">                
                <div id="resumo">
                    <p>The Batman é um filme inspirado no estilo noir, mostrando o lado mais investigativo do herói e uma luta identitária entre Batman e Bruce Wayne. </p>
                </div>
                <div id="sessoes">
                    <div id="center">
                        <div id="titEventos">
                    ...
                    <!-- Swiper -->
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide"><p>Sexta-feira</p><p>22:30</p></div>
                            <div class="swiper-slide"><p>Sábado</p><p>19:00</p></div>
                            <div class="swiper-slide"><p>Domingo</p><p>21:00</p></div>
                        </div>
                        <!-- Add Arrows -->
