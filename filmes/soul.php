...
<body>
    <div id="content">
        ...
        <header id="headerSessões">
                           ...
                           echo"
                            ...
                            <div id='user'>
                                ...
                                <div id='logout' style='z-index: 1000; border: 2px solid rgb(116, 108, 2,.5);'>
                                    ...
                                    <a href='soul.php?logout=true'>Sair</a>
                                </div>
                            </div>";
            ...
            <div id="banner" style="background-image: url(../img/soul.png);"></div>
        </header>
        <div id="mainFilmes">
            <!---------------------Quadro Cadeiras--------------------->
            ...
            <h1 id="titulo-filme" data-filme="Soul">SOUL</h1>
            <div id="extras">
                <div id="trailer">
                    <!--No link colocar /embed/o código do vídeo-->
                    <iframe src="https://www.youtube.com/embed/ccPhZng6hCc?fs=1" allowfullscreen></iframe>
                </div>
                <ul id="informacoes">
                    <li><span>Gênero:</span> Animação, Aventura, Família</li>
                    <li><span>Duração:</span> 1h 30min</li>
                    <li><span>indicação:</span> Livre</li>
                    <li><span>Direção:</span>  Pete Docter, Kemp Powers</li>
                    <li><span>Elenco:</span>  Jamie Foxx, Tina Fey, Daveed Diggs</li>
                    <li><span>Nacionalidade:</span> EUA</li></li>
                </ul>
            </div>
            <div id="principal">                
                <div id="resumo">
                    <p>Em Soul, Joe Gardner é um professor de música de ensino fundamental desanimado por não conseguir alcançar seu sonho de tocar no lendário clube de jazz The Blue Note, em Nova York. Quando um acidente o transporta para fora do seu corpo, fazendo com que ele exista em outra realidade na forma de sua alma, ele se vê forçado a embarcar em uma aventura ao lado da alma de uma criança que ainda está aprendendo sobre si, para aprender o que é necessário para retomar sua vida.</p>
                </div>
                <div id="sessoes">
                    <div id="center">
                        <div id="titEventos">
                    ...
                    <!-- Swiper -->
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><p>Sexta-feira</p><p>18:00</p></div>
                            <div class="swiper-slide"><p>Sexta-feira</p><p>21:50</p></div>
                            <div class="swiper-slide"><p>Sábado</p><p>17:20</p></div>
                            <div class="swiper-slide"><p>Sábado</p><p>20:10</p></div>
                            <div class="swiper-slide"><p>Domingo</p><p>18:00</p></div>
                        </div>
                        <!-- Add Arrows -->
