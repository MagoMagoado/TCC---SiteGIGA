...
<html lang="pt-br">
<head>
    <title>Um Lugar Silencioso II | Cinema GIGA</title>
    <meta charset="UTF-8">
...
<body>
    <div id="content">
        ...
        <header id="headerSessões">
                           ...
                           echo"
                            ...
                            <div id='user'>
                                ...
                                <div id='logout' style='z-index: 1000; border: 2px solid rgb(116, 108, 2,.5);'>
                                    ...
                                    <a href='lugar-silencioso.php?logout=true'>Sair</a>
                                </div>
                            </div>";
            ...
            <div id="banner" style="background-image: url(../img/um-lugar-silencioso.jpg);"></div>
        </header>
        <div id="mainFilmes">
            <!---------------------Quadro Cadeiras--------------------->
            ...
            <h1 id="titulo-filme" data-filme="Um Lugar Silencioso II">UM LUGAR SILENCIOSO II</h1>
            <div id="extras">
                <div id="trailer">
                    <!--No link colocar /embed/o código do vídeo1-->
                    <iframe src="https://www.youtube.com/embed/tJt2MS53cdM?fs=1" allowfullscreen></iframe>
                </div>
                <ul id="informacoes">
                    <li><span>Gênero:</span> Suspense, Fantasia, Terror</li>
                    <li><span>Duração:</span> 1h 45min</li>
                    <li><span>indicação:</span> +18</li>
                    <li><span>Direção:</span>  John Krasinski</li>
                    <li><span>Elenco:</span>  Emily Blunt, Cillian Murphy, Millicent Simmonds</li>
                    <li><span>Nacionalidade:</span> EUA</li></li>
                </ul>
            </div>
            <div id="principal">                
                <div id="resumo">
                    <p>Um Lugar Silencioso - Parte 2, logo após os acontecimentos mortais, a família Abbott precisa agora encarar o terror mundo afora, continuando a lutar para sobreviver em silêncio. Obrigados a se aventurar pelo desconhecido, eles rapidamente percebem que as criaturas que caçam pelo som não são as únicas ameaças que os observam pelo caminho de areia.</p>
                </div>
                <div id="sessoes">
                    <div id="center">
                        <div id="titEventos">
                    ...
                    <!-- Swiper -->
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><p>Segunda-feira</p><p>21:10</p></div>
                            <div class="swiper-slide"><p>Sexta-feira</p><p>23:30</p></div>
                            <div class="swiper-slide"><p>Sábado</p><p>23:30</p></div>
                            <div class="swiper-slide"><p>Domingo</p><p>23:30</p></div>
                        </div>
                        <!-- Add Arrows -->
